...
import SVG2 from "../assets/SVG Components/SVG2";
import SVG5 from "../assets/SVG Components/SVG5";
...
export default function NoteSmallView({ params }) {
  const { chosen, setShowNote, width, trackTagsChange, note, handleEditNote } =
    params;
  const {
    title = "",
    tags = [],
