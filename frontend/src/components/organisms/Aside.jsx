    ...
    return (
        <>
            <aside className={showSide ? "" : "moveLift"}>
                ...
                <div className="asideHeader">
                    ...
                    >
                        <span className="itsLife">
                            {svgg}
                            {width > 1025 ? <span>All notes</span> : ""}
                        </span>
                        {width > 1025 && (
                            SVG10
                        )}
                    ...
                    <button
                        onClick={() => handleNoteState(0)}
                        className={isArchived ? "btnLight btnHovered" : "btnLight"}
                    >
                        <span className="itsLife">
                            {SVG11}
                            {width > 1025 ? <span>Archived notes</span> : ""}
                        </span>
                        {width > 1025 && (
                            SVG12
                        )}
                ...
                <button className="hideSideOut" onClick={() => setShowSide(false)}>
                    hide-bar
                </button>
                <Tags handleTagSelect={handleTagSelect} data={note}></Tags>
            </aside>
            {!showSide && (
                <div onClick={() => setShowSide(!showSide)} className="spanner">
                    {SVG13}
                </div>
            )}
        </>
...
const SVG13 = <svg width="16" height="11" xmlns="http://www.w3.org/2000/svg">
    <path
